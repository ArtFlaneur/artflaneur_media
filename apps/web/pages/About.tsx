    ...
    <div className="bg-white">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-[26px] text-art-red font-bold mb-8">
            We Are Art Flaneur
          </h1>
      ...
      <div>
        <div className="container mx-auto px-4 md:px-6 py-12">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-[26px] text-art-red font-bold mb-6">
        ...
        <div className="container mx-auto px-4 md:px-6 py-12">
          <div className="max-w-4xl mx-auto">
            <div className="space-y-8">
              <div>
                <h3 className="text-[26px] text-art-red font-bold mb-6">
